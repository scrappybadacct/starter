...
import { numBinarySearch } from "../src/cs-algos/search/binarySearch";
  ...
  it("should match native indexOf(adapted to use Options)", () => {
    fc.assert(
      fc.property(fc.array(fc.integer()), fc.integer(), (data, tgt) => {
        const x = numBinarySearch(tgt, data);
